...
export default function Footer() {
  return (
    <footer className="bg-[#162636] text-[#F2F6FA]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/about" className="text-[#D6E1EB] hover:text-[#EAF3F8] transition-colors">
                  About
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/contact" className="text-[#D6E1EB] hover:text-[#EAF3F8] transition-colors">
                  Contact
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-[#2B3D4E] mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              ...
              <Link href="/terms" className="text-[#C3D2DF] hover:text-[#EAF3F8] text-sm transition-colors">
                Terms of Service
              </Link>
            </div>
          </div>
